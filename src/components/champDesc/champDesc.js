...
export const desc = {
    first: {
        Lux: {
            ...
            video: "https://www.youtube.com/embed/zbC54ph3A3o"
        },
        Leblanc: {
    ...
    second: {
        ...
        Kennen: {
            ...
            video: "https://www.youtube.com/embed/-_DED-6Txww"
        },
        Rumble: {
...
export const patchChamp = {
    buff: {
        Akali: [
            {
                skill: {
                    name: "Five Point Strike",
                    update: "DAMAGE: 25/50/75/100/125 (+0.65 total attack damage) (+0.6 ability power) ⇒ 30/55/80/105/130 (+0.65 total attack damage) (+0.65 ability power)"
                },
                passive: {
                    name: "",
                    update: ""
        ...
        Brand: [
            {
                ...
                passive: {
                    name: "Blaze",
                    update: "ABLAZED KILL MANA RESTORE: 6-18 (levels 1-18) ⇒ 20-40 (levels 1-18)"
                },
                bug: {
                    name: "",
                    update: ""
